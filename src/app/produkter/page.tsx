...
function ProductsContent() {
  ...
  return (
    <div style={{ paddingTop: 68 }}>
      {/* Page header */}
      <div style={{ background: 'linear-gradient(180deg, rgba(232,184,75,.05) 0%, transparent 100%)', borderBottom: '1px solid var(--line)', padding: '52px 24px 48px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 16, color: 'var(--text2)', margin: '0 0 32px', maxWidth: 480, marginInline: 'auto', lineHeight: 1.7 }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        {loading ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: 20 }}>
            {filtered.map(p => (
              <div key={p.id} style={{ background: 'var(--bg3)', border: '1px solid var(--line)', borderRadius: 14, overflow: 'hidden', display: 'flex', flexDirection: 'column', transition: 'all .2s' }}
